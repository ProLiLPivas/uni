...
import work4.BurningShip;
import work4.Tricorn;
...
public class FractalExplorer_v3 {
    private int size;
    ...
    public FractalExplorer_v3(int size) {
        this.size = size;
...
/**Метод done() вызывается, когда фоновая задача завершена*/
    ...
    public static void main(String[] args) {new FractalExplorer_v3(600);}
